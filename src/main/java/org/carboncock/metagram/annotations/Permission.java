...
public @interface Permission {
     ...
     * @throws org.carboncock.metagram.exceptions.ListFieldNotFoundException if the list cannot be found/accessed*/
    Class<?> listLocation();
     ...
     * @throws org.carboncock.metagram.exceptions.IllegalSendingMethodException if you choose as a method <code>ANSWER_CALLBACK_QUERY</code>
